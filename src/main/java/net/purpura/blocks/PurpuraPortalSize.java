...
public class PurpuraPortalSize {

    private static boolean isPurpuraPortalFrame(IBlockReader world, BlockPos pos) {
        return world.getBlockState(pos).getBlock() == Purpura.PURPURIUM_BLOCK.get();
    }

    private static final AbstractBlock.IPositionPredicate FRAME = (p_242966_0_, p_242966_1_, p_242966_2_) -> isPurpuraPortalFrame(p_242966_1_, p_242966_2_);
    ...
    public static Optional<PurpuraPortalSize> findEmptyPortalShape(IWorld p_242964_0_, BlockPos p_242964_1_, Direction.Axis p_242964_2_) {
        return findPortalShape(p_242964_0_, p_242964_1_, (p_242968_0_) -> {
            return p_242968_0_.isValid() && p_242968_0_.numPortalBlocks == 0;
        }, p_242964_2_);
    }

    public static Optional<PurpuraPortalSize> findPortalShape(IWorld p_242965_0_, BlockPos p_242965_1_, Predicate<PurpuraPortalSize> p_242965_2_, Direction.Axis p_242965_3_) {
        Optional<PurpuraPortalSize> optional = Optional.of(new PurpuraPortalSize(p_242965_0_, p_242965_1_, p_242965_3_)).filter(p_242965_2_);
        if (optional.isPresent()) {
            return optional;
        } else {
            Direction.Axis direction$axis = p_242965_3_ == Direction.Axis.X ? Direction.Axis.Z : Direction.Axis.X;
            return Optional.of(new PurpuraPortalSize(p_242965_0_, p_242965_1_, direction$axis)).filter(p_242965_2_);
        }
    }

    public PurpuraPortalSize(IWorld p_i48740_1_, BlockPos p_i48740_2_, Direction.Axis p_i48740_3_) {
    ...
    public void createPortalBlocks() {
        BlockState blockstate = Purpura.PURPURA_PORTAL.get().defaultBlockState().setValue(PurpuraPortalBlock.AXIS, this.axis);
